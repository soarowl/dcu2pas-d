...
64 10 49 53 50 65 72 6D 4F 62 6A 46 69 6C 65 53 74 6D | 00 00 00 00
```

- Delphi7

```
64 08 53 79 73 55 74 69 6C 73 | C8 43 D2 EF 00 00 00 00
64 10 49 53 50 65 72 6D 4F 62 6A 46 69 6C 65 53 74 6D | 20 36 1D 99 00 00 00 00
```

- >= Delphi2006

```
64 06 53 79 73 74 65 6D | 00 00
```
